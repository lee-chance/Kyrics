 ...
 */
public class OthersRequestFragment extends Fragment {

    SwipeRefreshLayout swipeRefreshLayout;
    RecyclerView rv_othersRequest;
    ManagerAdapter managerAdapter;
    List<ManagerModelList> managerModelListList;


    public OthersRequestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_others_request, container, false);
        ...
        rv_othersRequest = view.findViewById(R.id.rv_othersRequest);

        rv_othersRequest.setHasFixedSize(true);
        rv_othersRequest.setLayoutManager(new LinearLayoutManager(getActivity()));
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        for (DocumentChange dc : queryDocumentSnapshots.getDocumentChanges()){
                            ...
                            if(!(others.equals(""))){
                                ...
                                ManagerModelList data = new ManagerModelList(nickname, others);
                        ...
                        rv_othersRequest.setAdapter(managerAdapter);
                    }
                });
    }
